...
<div class="container py-5">
    ...
    <div class="card shadow-sm border-0 mb-5">
        <div class="card-body">
            <form action="{{ route('videoteca.guardar') }}" method="POST" class="row g-3 align-items-center">
                @csrf
                <div class="col-md-4">
                    <input type="text" name="titulo" class="form-control" placeholder="Título del video" required>
                </div>
                <div class="col-md-5">
                    <input type="url" name="url" class="form-control" placeholder="URL de YouTube" required>
                </div>
                    ...
                    <div class="card video-card border-0 shadow-sm h-100">
                        ...
                        <div class="card-body text-center">
                            ...
                            <div class="d-flex justify-content-center mt-2">
                                ...
                                <a href="{{ route('videoteca.editar', $video->id) }}" 
                                   class="btn btn-warning btn-sm me-2">
                                Editar
                                </a>

                                <form action="{{ route('videoteca.eliminar', $video->id) }}" 
                                      method="POST" 
