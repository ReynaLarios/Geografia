 ...
 @section('contenido')
     <section class="bg-white dark:bg-gray-900 py-8">
         <div class="container mx-auto px-4">
             ...
             con objeto de que se incorporen a los mercados de trabajo.
             <p class="text-gray-500 dark:text-gray-400 mt-2"></p>
             ...
             sus problemas y proponer alternativas de solución a los conflictos y tensiones de los territorios.
             <p class="text-gray-500 dark:text-gray-400 mt-2"></p>
             <p class="fw-bold"> MODALIDAD
             <p class="text-gray-500 dark:text-gray-400 mt-2"></p>
