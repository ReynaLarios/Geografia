     ...
     <section class="bg-white dark:bg-gray-900 py-8">
         <div class="container mx-auto px-4">
             ...
             <div class="text-center mb-8">
                 <h2 class="text-3xl font-extrabold text-gray-900 dark:text-white">LICENCIATURA EN GEOGRAFÍA/CIENCIAS </h2>
             ...
             <p>
                 ...
                 <a href="http://www.udg.mx/es/aspirantes/registro-de-tramites" target="_blank">
                     http://www.udg.mx/es/aspirantes/registro-de-tramites
                 </a>
             </p>

             <p class="text-gray-500 dark:text-gray-400 mt-2"></p>
             <p class="fw-bold">Presentación
             ...
             <p></p>
             <p class="fw-bold">Las competencias sobre las que gira el plan de estudios incorporan los avances de la
                 disciplina en la ordenación territorial:
            ...
            <p>
             ...
             superior y básico.
             Son competencias que se concretan con la incorporación de destrezas y habilidades que adquieren sus egresados,
             con objeto de que se incorporen a los mercados de trabajo. </p>
             <p>
             El abanico de alternativas laborales que cubren diversos temas como la creciente expansión las ciudades, la
             presión de áreas rural, la desarticulación de la producción agropecuaria, los riesgos ambientales, las disputas
             por el agua, la contaminación del aire, ríos y lagos la conservación y protección de áreas naturales, el cambio
             climático, los efectos en la salud pública, pobreza, desigualdad y en general la calidad de vida. </p>
             <p>
             ...
             patrones de distribución espacial en el territorio y acercamientos analíticos a los lugares.
             Los geógrafos formados en nuestras aulas adquieren competencias que les permiten leer la realidad, identificar
             sus problemas y proponer alternativas de solución a los conflictos y tensiones de los territorios. </p>
             <p>
             ...
             requerimientos de los programas educativos a su propio ritmo. </p>
         @endsection
